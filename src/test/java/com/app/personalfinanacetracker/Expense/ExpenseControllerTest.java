...
import com.app.personalfinanacetracker.controller.ExpenseController;
...
public class ExpenseControllerTest {
    ...
    @Test
    public void testRetrieveExpenseByDate() {
        //Create sample DTO & extract test date
        ExpenseDTO dto = createExpenseDTO();
        LocalDate testDate = dto.getDate();

        //Mock service response for retrieving by date
        when(expSvc.retrieveExpenseByDate(testDate)).thenReturn(dto);

        //Act: call controller
        ResponseEntity<ExpenseDTO> response = controller.retrieveExpenseByDate(testDate);
